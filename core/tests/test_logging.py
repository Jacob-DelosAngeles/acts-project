...
class TestLogging:
    def test__get_logger__correct_return(self):
    ...
    def test__logging_constants__value_equality(
        self,
        input_value,
        expected_output,
    ):
    ...
    def test__logger__running(self, logger):
        logger.running("Running message")

    def test__logger__success(self, logger):
        logger.success("Success message")

    @mock.patch("acts.core.logging.os.environ.get")
