...
document.addEventListener('DOMContentLoaded', () => {
  // Attach appbar
  ACTS.ui.appbar = MDCTopAppBar.attachTo(
      document.querySelector('#acts-appbar'));
  ...
  ACTS.ui.inputFileButtonLabel =
      ACTS.ui.inputFileButton.children('.mdc-fab__label');
  ACTS.ui.uploadInputButtonLabel =
      ACTS.ui.uploadInputButton.children('.mdc-fab__label');
  ...
  ACTS.ui.uploadInputChoiceFile =
      $('#acts-upload-input-dialog__file-input-choice');

  // Attach input file upload components (Material Component)
  ACTS.ui.mdc.inputFileButton =
      MDCRipple.attachTo(ACTS.ui.inputFileButton[0]);
  ACTS.ui.mdc.uploadInputButton =
      MDCRipple.attachTo(ACTS.ui.uploadInputButton[0]);
  ACTS.ui.mdc.uploadInputDialog =
      MDCDialog.attachTo(ACTS.ui.uploadInputDialog[0]);
